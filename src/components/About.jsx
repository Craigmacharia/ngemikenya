      ...
      <div className="container">
        ...
        >
          ...
          <p className="lead text-secondary header-subtitle">
            Crafting digital experiences with authentic Kenyan perspectives and technical excellence
          </p>
                ...
                <div className="col-md-8">
                  <div className="card-body p-4 p-lg-5">
                    ...
                    <p className="text-secondary lead mb-4">
                      Welcome to my digital sanctuary where technology meets authentic storytelling. 
                      I'm passionate about bridging the gap between complex technical concepts and 
                      real-world applications through the lens of Kenyan innovation.
                    </p>
                    <p className="text-secondary mb-4">
                      With a background in software engineering and a deep love for the African tech ecosystem, 
                      I create content that educates, inspires, and connects developers across the continent. 
                      Each post is crafted from hands-on experience and genuine curiosity.
                    </p>
                    <div className="d-flex flex-wrap gap-2 mb-4">
                      <span className="badge bg-primary text-white rounded-pill px-3 py-2">
                        <i className="bi bi-code-slash me-1"></i>Full-Stack Development
                      </span>
                      <span className="badge bg-primary-light text-white rounded-pill px-3 py-2">
                        <i className="bi bi-cloud me-1"></i>Cloud Architecture
                      </span>
                      <span className="badge bg-gold text-dark rounded-pill px-3 py-2">
                        <i className="bi bi-pencil me-1"></i>Technical Writing
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="card border-0 shadow-lg rounded-4 bg-white">
              <div className="card-body p-4 p-lg-5">
                ...
                <div className="row text-center">
                  {[
                    { icon: 'bi-journal-richtext', number: '85', suffix: '+', label: 'Articles Published', target: 85 },
                    { icon: 'bi-eye', number: '50', suffix: 'K+', label: 'Total Reads', target: 50 },
                    { icon: 'bi-people', number: '10', suffix: 'K+', label: 'Community Members', target: 10 },
            ...
            <div className="card border-0 shadow-lg rounded-4 bg-white h-100">
              <div className="card-body p-4 p-lg-5">
                ...
                <div className="timeline">
                  {[
                    { year: '2018', title: 'First Lines of Code', description: 'Started the programming journey with Python and never looked back' },
                    { year: '2020', title: 'Full-Stack Transition', description: 'Dove deep into JavaScript ecosystem and modern web development' },
                    { year: '2022', title: 'Cloud Certification', description: 'Mastered cloud technologies and DevOps practices' },
                    { year: '2023', title: 'NgemiKenya Launch', description: 'Started sharing knowledge through technical blogging' },
                    { year: '2024', title: 'Community Growth', description: 'Building the next generation of African developers' }
                  ].map((milestone, index) => (
                ...
                <div className="row g-4">
                  {[
                    ...
                    { 
                      ...
                      title: 'Quality', 
                      description: 'Crafting robust, maintainable code and thoroughly researched content',
                      color: 'bg-primary-light'
                    },
                    { 
                      icon: 'bi-people', 
                      title: 'Community', 
                      description: 'Empowering others through knowledge sharing and collaborative growth',
                      color: 'bg-primary'
                    },
                    { 
                      icon: 'bi-globe', 
                      title: 'Impact', 
                      description: 'Creating solutions that address real challenges in the African context',
                      color: 'bg-primary-light'
                    }
                  ].map((value, index) => (
          ...
          <div className="col-lg-8">
            <div className="card border-0 bg-primary text-white rounded-4 shadow-xl">
              <div className="card-body p-5 text-center">
                ...
                <h3 className="fw-bold mb-3">Let's Build Together</h3>
                <p className="lead mb-4 opacity-90">
                  Ready to collaborate on innovative projects or discuss the future of tech in Africa?
                </p>
